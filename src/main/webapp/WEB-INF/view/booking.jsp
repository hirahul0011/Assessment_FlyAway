...
<body>
	...
	<div align="center">
	<h1>Please confirm your booking details and proceed for payment</h1>
	<table>
		<%-- <% int i=1; %> --%>	
		...
		<tr>			
			...
			<td><fmt:formatDate value="${travelDate}" pattern="EEEEE MMMMM dd yyyy" />						
		</tr>
		<tr>
			<td>Flight ID: </td>
			<td>${ID}</td>			
	...
	<table>							
		<tr>			
			...
			&billingAmount=${billingAmount}">Confirm and Pay</a></td>
